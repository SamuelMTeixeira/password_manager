...
<head>
    ...
    <title>{{ config('app.name', 'DataLock') }}</title>
...
<body class="relative bg-white md:overflow-hidden">
                    ...
                    <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start"
                        ...
                        <div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                            <div class="flex items-center justify-between w-full md:w-auto">
                                <a href="#">
                                    <span class="sr-only">DataLock</span>
                                    <img alt="Workflow" class="h-8 w-auto sm:h-10" src="{{ asset('img/logo.png') }}">
                                </a>
                        ...
                        <div class="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                            <a href="#" class="font-medium text-gray-500 hover:text-gray-900">Assinar premium</a>

                            <a href="#" class="font-medium text-gray-500 hover:text-gray-900">Sobre</a>
            ...
            <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div class="sm:text-center lg:text-left">
                    <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                        <span class="block">+ segurança e</span>
                        <span class="block text-indigo-600 xl:inline">totalmente gratuito</span>
                    </h1>
                    <p
                        class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                        O Datalock é um gerenciador de senhas feito para te proporcionar uma melhor segurança e controle
                        você, evitando que você decore todas as suas senhas. Teste já!</p>
