    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6 gap-5">
                ...
                <form>
                    <label for="search"
                        class="mb-2 text-sm font-medium bg-gray-100 sr-only">Pequise</label>
                ...
                <button class="rounded-full bg-gray-50 h-10 w-10">
                    ...
                    <x-slot name="trigger">
                        <button
                            ...
                            <img class="rounded-full h-10 w-10"
                                src="https://i.pinimg.com/736x/01/f6/50/01f650c33bf30fde96772e3e0ec551f3.jpg">
                        </button>
                    </x-slot>
